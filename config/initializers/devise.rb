...
Devise.setup do |config|
  ...
  # (e.g. a value of 20 is already extremely slow: approx. 60 seconds for 1
  # calculation).
  config.stretches = Rails.env.test? ? 1 : 10

  # Setup a pepper to generate the encrypted password.
  # config.pepper = 'be5c0dc8cbbebe692e4bdc360ad16ccc2dfd8278ff71725764361d41a4'
  ...
  # You can use
  # :sha1, :sha512 or encryptors from others authentication
  # tools as :clearance_sha1,
  # :authlogic_sha512
